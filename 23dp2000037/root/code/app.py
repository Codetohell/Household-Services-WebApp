...
def user_login():
    if request.method == 'POST':
        ...
        customer =  Customer.query.filter_by(email=email.lower(), password=password).first()
        if customer:
        ...
        professional = Professional.query.filter_by(email=email.lower(), password=password).first()
        if professional:
        ...
        admin = Admin.query.filter_by(email=email.lower(), password=password).first()
        if admin:
